$(document).ready(function(){
    ...
    $(".apafa").on('click','.btn_guardar_editar', function(e) {
    ...
    $(".apafa").on('click','.btn_asignar_nombre_oi', function(e) {
    ...
    $(".apafa").on('change','.buscar_periodo_sgt', function() {
    ...
    $(".apafa").on('click','#checkconei', function() {
    ...
    $(".apafa").on('click','.editardirector', function() {
    ...
    $(".apafa").on('click','.btn-guardar-conei', function() {
...
// 
    ...
    $(".apafa").on('click','.btn-next-tab01', function() {
        event.preventDefault();
    ...
    $(".apafa").on('click','.btn-next', function() {
        event.preventDefault();
    ...
    $(".apafa").on('click','.btn-confirmar', function() {
    ...
    $(".apafa").on('change','#tdgoi', function() {
        var tdg        =   $(this).val();
        if(tdg =='TIDO00000001'){ 
    ...
    $(".apafa").on('click','.modal-registro', function() {
        event.preventDefault();
        var _token                  =   $('#token').val();
    ...
    $(".apafa").on('click','.modal-registro-variable', function() {
        event.preventDefault();
        var _token                  =   $('#token').val();
    ...
    $(".apafa").on('click','.modal-registro-oi', function() {
        ...
        ajax_modal(data,"/ajax-modal-registro-oi-apafa",
                  "modal-conei-apafa","modal-conei-apafa-container");

    });


    $(".apafa").on('click','.btn_buscar_dni_oi', function(e) {
        event.preventDefault();
    ...
    $(".apafa").on('click','.btn_buscar_dni', function(e) {
        event.preventDefault();
    ...
    $(".apafa").on('click','.btn_buscar_dni_director', function(e) {
        event.preventDefault();
    ...
    $(".apafa").on('click','.btn-limpiar', function(e) {
    ...
    $(".apafa").on('click','.btn_asignar_nombre', function(e) {
    ...
    function actualizar_ajax_oi(_token,carpeta,tdg,tdgtexto,documentog,nombresg,cargo,array_detalle_producto,representante_id,representante_txt,codigo_modular_id,niveltexto){
        ...
        $.ajax({
            type    :   "POST",
            url     :   carpeta+"/ajax-lista-tabla-oi-apafa",
            data    :   {
                            _token              : _token,
                            tdg                 : tdg,
                            tdgtexto            : tdgtexto,
    ...
    function eliminar_ajax_oi(_token,carpeta,fila,array_detalle_producto){
        ...
        $.ajax({
            type    :   "POST",
            url     :   carpeta+"/ajax-elminar-fila-tabla-oi-apafa",
            data    :   {
                            _token          : _token,
                            fila            : fila,
                            array_detalle_producto : array_detalle_producto

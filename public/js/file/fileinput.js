...
(function (factory) {
    ...
    $h = {
        ...
        closeButton: function (css) {
            ...
            return '<button type="button" class="' + css + '" aria-label="Close"><span class="mdi mdi-close-circle-o"></span>\n' +
                ($h.isBs(5) ? '' : '  <span class="mdi mdi-close-circle-o" aria-hidden="true">&times;</span>\n') +
                '</button>';
        },

                ...
                <div class="panel panel-default panel-border-color panel-border-color-success">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="listadatos">  
                            <form method="POST" action="{{ url('subir-excel-cargar-datos-certificado/'.$idopcion) }}" name="formcargardatos" id="formcargardatos" enctype="multipart/form-data" >
                               {{ csrf_field() }}
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8" align="left" style="padding-bottom: 20px;">
                                                                <a 
                                                                  href="{{url('/formato-excel-cargar-datos-certificado/'.$idopcion)}}"  
                                                                  title="Descargar Formato Carga" 
                                                                  class="btn btn-secondary botoncabecera btn-lg" 
                                                                  id="btndescargarexcel" 
                                                                  class="btndescargarexcel"
                                                                  data-href="{{url('/formato-excel-cargar-datos-certificado/'.$idopcion)}}"  
                                                                  style="
                                                                  border-style: solid;

          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Lista de Unidad Medida
                  <div class="tools tooltiptop">

                    <a href="{{ url('/agregar-unidad-medida/'.$idopcion) }}" class="tooltipcss">
                      <span class="tooltiptext">Crear Unidad Medida</span>
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    @include('configuracion.ajax.alistaunidadmedida')
                  </div>

          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Lista de Categoria Servicio
                  <div class="tools tooltiptop">

                    <a href="{{ url('/agregar-grupo-servicio/'.$idopcion) }}" class="tooltipcss">
                      <span class="tooltiptext">Crear Categoria Servicio</span>
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    @include('configuracion.ajax.alistagruposervicio')
                  </div>

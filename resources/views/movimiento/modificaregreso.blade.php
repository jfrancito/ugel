    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">{{ $titulo }}<span class="panel-subtitle">Modificar Egreso : {{$egreso->serie}}-{{$egreso->numero}}</span></div>
          <div class="panel-body">
            <form method="POST" action="{{ url('/modificar-egreso/'.$idopcion.'/'.Hashids::encode(substr($egreso->id, -8))) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed formegreso" enctype="multipart/form-data">
                    {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                      ...
                      rows="5" 
                      cols="50"    
                      data-aw="12">{{$egreso->observacion}}</textarea>
                </div>
              </div>
              ...
              <div class="row xs-pt-15">
                ...
                <div class="col-xs-6">
                  <p class="text-right">
                    <button type="submit" class="btn btn-space btn-primary btn-guardar-egreso">Guardar</button>
                  </p>
                </div>
              </div>

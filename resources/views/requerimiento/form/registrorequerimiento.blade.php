    ...
    <legend>DATOS DE LA II.EE.</legend>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <input  type="text"
                    value="{{$institucion->codigoinstitucion}}"                         
                    required = ""
                    maxlength="300"                     
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <label class="control-label"><b>PROVINCIA <small class="">(II.EE.)</small> : </b></label>
            <input  type="text"
                    value="{{$institucion->provincia}}"                         
                    required = ""
                    maxlength="300"                     
                    autocomplete="off" class="form-control input-sm" readonly/>
          </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <label class="control-label"><b>DISTRITO <small class="">(II.EE.)</small> : </b></label>
            <input  type="text"
                    value="{{$institucion->distrito}}"                         
                    required = ""
                    maxlength="300"                     
                    autocomplete="off" class="form-control input-sm" readonly/>
          </div>

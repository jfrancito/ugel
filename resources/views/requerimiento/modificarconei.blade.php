          ...
          <div class="panel-body">
            <div class="col-sm-12">
              <div class="panel panel-default">
                <form method="POST" action="{{ url('/gestion-observacion-conei/'.$idopcion.'/'.Hashids::encode(substr($conei->id, -8))) }}" style="border-radius: 0px;" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    @include('requerimiento.form.modificarrequerimientoconei')
                </form>
              </div>
            </div>
          </div>

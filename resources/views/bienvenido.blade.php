						              ...
						              <div class="panel panel-contrast color_azul" style="margin-bottom:0px;border-radius:0px;">
						                <div class="panel-body">
						                	<!-- <h3 class="cblanco center"><b>INSTITUCION</b>  </h3> -->
						                  	...
						                  	<h5 class="center color_azulclaro cursiva" style="margin-bottom:0px;margin-top: 0px;"><b>CODIGO LOCAL</b></h5>
						                  	<h3 class="center cblanco"><b> {{strtoupper(Session::get('institucion')->nombre)}}</b></h3>
						                  	<h5 class="center color_azulclaro cursiva" style="margin-bottom:0px;margin-top: 0px;">
						              ...
						              <div class="panel panel-contrast" style="margin-bottom:0px;border-radius:0px;">
						                <div class="panel-body ">
						                	<!-- <h3 class="center"><b>DIRECTOR</b>  </h3> -->
						                  	<h3 class="center cazul"><b> {{strtoupper(Session::get('direccion')->dni)}}</b></h3>
						                  	<h5 class="center color_gris cursiva" style="margin-bottom:0px;margin-top: 0px;"><b>DNI</b></h5>

						                  	<h3 class="center cazul"><b> {{strtoupper(Session::get('direccion')->nombres)}}</b></h3>
						                  	<h5 class="center color_gris cursiva" style="margin-bottom:0px;margin-top: 0px;"><b>NOMBRES</b></h5>

						                  	<h3 class="center cazul"><b> {{strtoupper(Session::get('direccion')->telefono)}}</b></h3>
						                  	<h5 class="center color_gris cursiva" style="margin-bottom:0px;margin-top: 0px;"><b>TELEFONO</b></h5>

						                  	<h3 class="center cazul"><b> {{strtoupper(Session::get('direccion')->correo)}}</b></h3>
						                  	<h5 class="center color_gris cursiva" style="margin-bottom:0px;margin-top: 0px;"><b>CORREO</b></h5>					                  	
						                </div>
						              </div>
						            </div>
						    </div>

          ...
          <div class="panel-body">
            <div class="col-sm-12">
              <div class="panel panel-default">
                <form method="POST" action="{{ url('/gestion-admin-conei-estado/'.$idopcion.'/'.Hashids::encode(substr($conei->id, -8))) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                        {{ csrf_field() }}
...
@section('script')
  ...
  <script src="{{ asset('public/js/requerimiento/gconei.js?v='.$version) }}" type="text/javascript"></script>
